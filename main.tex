...
\begin{enumerate}
	...
	\begin{itemize} 
	\item $\orb(e)=\{geg^{-1}, g\in G\}=\{e\}$ Donc l'action n'est pas transitive si $G eq\{e\}$ \\%img 1\\
...
\emph{Ces deux définitions sont bien équivalents}.
\begin{proof}
...
\begin{exercise}
	...
	\leavevmode
		...
		En effet les endomorphismes de $V$ sont les \textdemp{homothéties}: $f_\lambda: V\rightarrow V x\rightarrow \lambda x(\lambda\in \C^\ast)$. Et $GL(V)\rightarrow  G^\ast$ est un isomorphisme $f_\lambda\rightarrow \lambda$.
...
Alors	 $\left(\faktor{\Z}{33\Z}\right)^*\simeq (\faktor{\Z}{2\Z})\times (\faktor{\Z}{10\Z}) ot\simeq \faktor{\Z}{20\Z}$ car $(2,10) eq 1$. Donc $\left(\faktor{\Z}{33\Z}\right)^{\ast}$ n'est pas cyclique.
